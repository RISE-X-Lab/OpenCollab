...
is not returned to you. Your budget for this run is 4,000,000 tokens, and each
Coder's is the same. On these tasks, a single agent working alone used 1,320,000
tokens on average (median 1,470,000).
