...
## What the other two are doing right now

The Coder and the Tester are running. Each has a full token budget and an empty
conversation, and neither has anything to work on: nothing reaches them except
a message from you. For as long as you do not write to them, two thirds of the
agents on this run sit idle and two thirds of its budget goes unspent.
