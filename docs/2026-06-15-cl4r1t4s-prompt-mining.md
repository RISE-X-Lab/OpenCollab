...
Relevant files: `/home/xuzhenhua/git/OpenCollab/opencollab/opencollab/adapters/tools/fs.py`, `.../bash.py`, `.../run_tests.py`, `.../apply_patch.py`; `/home/xuzhenhua/git/OpenCollab/workflows/self_collab.py`, `.../split_solve.py`; `/home/xuzhenhua/git/OpenCollab/configs/team.self.collab.yaml`; `/home/xuzhenhua/git/OpenCollab/opencollab/opencollab/bootstrap/team_config.py` (`DEFAULT_LEAD_PROMPT:44`, `DEFAULT_ROLE_PROMPT:83`); `/home/xuzhenhua/git/OpenCollab/opencollab/opencollab/adapters/safety.py`.
