...
# scheduler inbox. Keep each representation finite, using encoded bytes because
# that is stable across Python strings and directly bounds serialized payloads.
