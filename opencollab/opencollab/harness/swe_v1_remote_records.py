...
from opencollab.harness.swe_eval_records import SUBMISSION_INTEGRITY_PROVEN
from opencollab.harness.swe_generation_proof import current_generation_proof_valid
