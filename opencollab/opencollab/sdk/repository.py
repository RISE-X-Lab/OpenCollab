...
async def build_repository_map(
    ...
    *,
    ...
    return await build_repo_map_via_env(environment, max_depth=max_depth, max_chars=max_chars)
...
def build_patch_command(
    *,
    ...
    return guarded_staged_diff_command(base_revision=base_revision, exclude_paths=exclude_paths)
