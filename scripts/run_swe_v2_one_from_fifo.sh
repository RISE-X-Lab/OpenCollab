...
export OPENCOLLAB_BASE_URL="${OPENCOLLAB_REMOTE_PROXY_BASE_URL:-http://127.0.0.1:18788}"
export ANTHROPIC_BASE_URL="${OPENCOLLAB_REMOTE_PROXY_BASE_URL:-http://127.0.0.1:18788}"
export OPENCOLLAB_MODEL="${OPENCOLLAB_MODEL:-glm-5.2}"
